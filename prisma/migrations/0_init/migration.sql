...
-- CreateEnum
CREATE TYPE "ContentModule" AS ENUM ('TECNOLOGIA', 'LIVROS', 'IDIOMAS', 'FORUM');

-- CreateEnum
CREATE TYPE "PostType" AS ENUM ('ARTICLE', 'VIDEO', 'PODCAST');
...
-- CreateEnum
CREATE TYPE "ForumTopicStatus" AS ENUM ('OPEN', 'CLOSED', 'PINNED');
...
-- CreateIndex
CREATE INDEX "Post_module_status_publishedAt_idx" ON "Post"("module", "status", "publishedAt");
...
-- CreateIndex
CREATE INDEX "Post_languageId_idx" ON "Post"("languageId");
...
-- CreateIndex
CREATE INDEX "Like_topicId_idx" ON "Like"("topicId");
...
-- CreateIndex
CREATE INDEX "ForumTopic_userId_idx" ON "ForumTopic"("userId");
...
-- AddForeignKey
ALTER TABLE "Like" ADD CONSTRAINT "Like_topicId_fkey" FOREIGN KEY ("topicId") REFERENCES "ForumTopic"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ForumTopic" ADD CONSTRAINT "ForumTopic_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
